...
self.addEventListener('push', event => {
  event.waitUntil((async()=>{
    ...
    await self.registration.showNotification(payload.title || 'Rally Fans Map', {
      ...
      icon: '/rfm/icon.png?v=__APP_VERSION_CACHE__',
