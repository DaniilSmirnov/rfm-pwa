const CACHE='rfm-companion-v040-local-maplibre';
const ASSET_CACHE='rfm-race-assets-v1';
const SHELL=['/','/index.html','/src/styles.css','/src/app.js','/src/db.js','/src/normalize.js','/src/map.js','/src/rallyfans.js','/src/yandex.js','/src/navigation.js','/src/offline-map.js','/vendor/maplibre/maplibre-gl.mjs','/vendor/maplibre/maplibre-gl-worker.mjs','/vendor/maplibre/maplibre-gl-shared.mjs','/vendor/maplibre/maplibre-gl.css','/manifest.webmanifest','/icon.svg','/rfm/icon.png','/assets/location.svg','/assets/document-copy.svg','/assets/arrow-right.svg','/assets/telegram.svg'];
const EXTERNAL=['https://unpkg.com/pmtiles@4.5.0/dist/pmtiles.js'];
